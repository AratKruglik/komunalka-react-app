...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  const baseClasses =
    'w-full py-2.5 rounded-md border-[0.5px] border-gray-300 text-base text-[#333333] placeholder:text-[#adaebc] bg-white transition-colors focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary'
